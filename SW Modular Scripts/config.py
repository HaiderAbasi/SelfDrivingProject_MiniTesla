...
vid_path = os.path.abspath("SW Modular Scripts/Detection/Lanes/Inputs/signs_forward.mp4")
#vid_path = os.path.abspath("SW Modular Scripts/Detection/Lanes/Inputs/in_16_2.avi")
loopCount=0
